...
public class YelpDao {
	...
	public List<User> getAllUsers(int rec, Map<String, User> idMap){
		String sql = "SELECT u.* "
	...
	public List<Adiacenza> getArchi(int anno, Map<String, User> idMap){
		String sql = "SELECT r1.user_id, r2.user_id, COUNT(r1.business_id) AS sim "
		...
		try {
			...
			while (res.next()) {
				...
				Adiacenza a = new Adiacenza(idMap.get(res.getString("r1.user_id")),
						idMap.get(res.getString("r2.user_id")),res.getInt("sim"));
